...
public class ByCountryAdapter extends RecyclerView.Adapter<ByCountryAdapter.AreaViewHolder> {

    private final Context context;
    private final List<CountryFilter> areas;
    private final AreaClickListener listener;

    public ByCountryAdapter(Context context, List<CountryFilter> areas, AreaClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull AreaViewHolder holder, int position) {
        CountryFilter area = areas.get(position);
    ...
    public interface AreaClickListener {
        void onAreaClicked(CountryFilter area);
    }
}
